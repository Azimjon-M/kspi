...
function Navbar() {
    ...
    return (
        <div
            ...
            }  left-0 flex flex-col justify-between w-full h-auto z-50 px-4 py-2 bg-[${color}] sm:px-4 md:px-8 md:py-4 xl:px-0 xl:py-0`}
        >
            {/* Navbar */}
            <nav className="flex flex-col h-[100px!important]">
                {/* Header */}
                <div className="hidden xl:flex xl:justify-end text-white rounded-bl-lg ">
