        ...
        <div className="absolute top-[40px] md:top-[50px] left-0 w-full z-10 bg-[rbga(0, 0, 0, 0)] px-4 py-2">
            <div className=" text-white flex justify-between items-center">
                ...
                <ul className="hidden lg:flex justify-end gap-x-2 items-center flex-wrap text-[14px] font-semibold select-none">
                    <li className="flex items-center cursor-pointer" onClick={() => {handleClickLi(1)}} >
                        INSTITUT
                        <DownUp color='white' $totop={isActive1} />
                    </li>
                    <li className="flex items-center cursor-pointer" onClick={() => {handleClickLi(2)}} >
                        FAOLIYAT
                        <DownUp color='white' $totop={isActive2} />
                    </li>
                    <li className="flex items-center cursor-pointer" onClick={() => {handleClickLi(3)}} >
                        TUZILMA
                        <DownUp color='white' $totop={isActive3} />
                    </li>
                    <li className="flex items-center cursor-pointer" onClick={() => {handleClickLi(4)}} >
                        YANGILIKLAR
                        <DownUp color='white' $totop={isActive4} />
                    </li>
                    <li className="flex items-center cursor-pointer" onClick={() => {handleClickLi(5)}} >
                        TALABALAR
                        <DownUp color='white' $totop={isActive5} />
                    </li>
                    <li className="flex items-center cursor-pointer" onClick={() => {handleClickLi(6)}} >
                        ABITURIENT
                        <DownUp color='white' $totop={isActive6} />
                    </li>
                    <li className="flex items-center cursor-pointer" onClick={() => {handleClickLi(7)}} >
